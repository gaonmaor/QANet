...
class Model(object):
    def __init__(self, config, batch, word_mat=None, char_mat=None,
                 trainable=True, opt=True, demo=False, graph=None):
        """

        :param config: Contains the configurations to be used.
        :param batch: The batch to be fed to this model.
        :param word_mat: The mapping matrix from word index to embedding.
        :param char_mat: The mapping matrix from char index to embedding.
        :param trainable: whether or not to train the weights or to freeze them.
        :param opt:
        :param demo: Indicate if demo mode is used.
        :param graph: The tensorflow graph instance.
        """
        self.config = config
        self.demo = demo
